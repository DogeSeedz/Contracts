// DogeSeedz Token
// https://dogeseedz.com
// A mineable proof of work coin with a parallel token 
//   
//  Max transfer (including selling) is 2% of total supply (anti whale dump)
//  Max of one transfer per 24 hours (includes selling) (anti whale dump)
//  Maximum yearly mint is parallel to PoW chain; 105,120,000 tokens / year
//  Once your tokens are minted they will be locked for 24 hours (max transfer)
//  Dev wallet CANNOT mint more than the amount set by maxSupplyAllowed
//
